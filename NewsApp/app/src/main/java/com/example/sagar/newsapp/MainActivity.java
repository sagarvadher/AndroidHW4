...
public class MainActivity extends  AppCompatActivity implements LoaderManager.LoaderCallbacks<Void>,
    ...
    //Set the adapter for showing the data in the recycler view
    ...
    //initialized the method for showing the newsAPI data when the application starts
    ...
    //implemented async task loader for appropriate loader callbacks
